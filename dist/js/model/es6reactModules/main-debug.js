...
define("model/es6reactModules/main-debug", ["model/es6reactModules/index-debug", "common/hoc-debug", "common/react-debug", "common/reflux-debug", "common/limit2-debug.0", "model/es6reactModules/view-debug", "model/es6reactModules/controller-debug", "common/controller-debug", "modules/ajax/main-debug", "common/widget-debug", "common/jquery-debug", "common/base-debug", "common/class-debug", "common/attrs-debug", "common/aspect-debug", "common/events-debug", "common/limit-debug", "common/limit-dom-debug"], function(require, exports, module) {
    return function(_require) {
        ...
        return _inherits(myWidget, _require), _createClass(myWidget, [{
            key: "getComponent",
            value: function() {
                return require("model/es6reactModules/index-debug")
            }
        }]), myWidget
    }(require("common/widget-debug"))
});
"use strict";
define("model/es6reactModules/index-debug", ["common/hoc-debug", "common/react-debug", "common/reflux-debug", "common/limit2-debug.0", "model/es6reactModules/view-debug", "model/es6reactModules/controller-debug", "common/controller-debug", "modules/ajax/main-debug"], function(require, exports, module) {
    return require("common/hoc-debug")(require("model/es6reactModules/view-debug"), require("model/es6reactModules/controller-debug"))
});
"use strict";
