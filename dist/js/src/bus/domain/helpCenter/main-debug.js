"use strict";
define("src/bus/domain/helpCenter/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/tab/main-debug"], function(require, exports, module) {
    function checkNext() {
        var me = this;
        me.get("mainIndex") >= me.maxIndex ? next.hide() : next.show()
    }
    ...
    new Tab({
        ...
        onChose: function(e, index) {
            (1 === index || 2 === index) && checkNext.call(1 === index ? a : b)
        }
    }), initScroll();
    var a = new Tab({
            element: "#prosecutor",
            ...
            events: {
                'click [data-role="next"]': function(e) {
                    var me = this;
                    me.tabShow(e, me.get("mainIndex") + 1), checkNext.call(me), domUtil.winScrollY($("#helpCenter").offset().top - 30)
                }
            },
            onChose: function(e, index) {
                var me = this;
