"use strict";
define("src/bus/cooperation/trilCaseForAeolus/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/delegate-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "model/filterConditions/main-debug", "model/modal/main-debug", "common/domUtil-debug", "common/handlerbars-debug", "model/ajax/main-debug", "model/searchList/main-debug", "common/statusMap-debug"], function(require, exports, module) {
    ...
    var $ = require("common/jquery-debug"),
        ...
        SearchList = (require("common/handlerbars-debug"), require("model/searchList/main-debug")),
    ...
    $("#search").on("click", function() {
        ...
        Modal.confirm("提示", "是否确认测试已通过?", function() {
            new Ajax({
                ...
                Modal.alert(1, rtv), searchListExp[0].searchListReload()
            }).submit()
        })
    })
});
