"use strict";
define("src/bus/aeolus/batchAssociate/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/delegate-debug", "common/limit-debug", "common/limit-dom-debug", "common/util-debug", "common/promise-debug", "model/filterConditions/main-debug", "model/modal/main-debug", "model/countDown/main-debug", "common/dialog-debug", "common/domUtil-debug", "common/handlerbars-debug", "model/ajax/main-debug", "model/searchList/main-debug", "transfer-debug", "common/statusMap-debug"], function(require, exports, module) {
            ...
            Dialog.showTemplate("#template-associate", aeolusAccountInfo.data, {
                ...
                events: {
                    "click .JS-trigger-click-sure": function() {
                        ...
                        aeolusAccountInfoId ? new Ajax({
                            request: "/aeolus/lassenMaintenanceRpc/batchConfirmAssociate.json",
                            param: $.extend({}, {
                                caseIds: caseIds,
                                aeolusAccountInfoId: aeolusAccountInfoId
                            }),
                            paramName: "filterMap"
    ...
    var $ = require("common/jquery-debug"),
        ...
        FilterConditions = (require("common/limit-debug"), require("common/util-debug"), require("model/filterConditions/main-debug")),
    ...
    require("transfer-debug"), require("common/handlerbars-debug"), require("common/statusMap-debug");
    $.ajaxSetup({
        cache: !1
    ...
    $("#search").on("click", function() {
        ...
        $('[data-role="confirm"]').removeClass("fn-btn-disabled"), $('[data-role="batch"]').addClass("fn-btn-disabled")
    }), delegate.on("click", '[data-role="norelation"]', function() {
        $('[data-role="batch"]').removeClass("fn-btn-disabled"), $('[data-role="confirm"]').addClass("fn-btn-disabled")
    }), delegate.on("click", '[data-role="any"]', function() {
        $('[data-role="batch"]').addClass("fn-btn-disabled"), $('[data-role="confirm"]').addClass("fn-btn-disabled")
    }), delegate.on("change", '[data-role="subCheck"]', function() {
        $("[data-role='check']").prop("checked", $(this).prop("checked")), 0 == $("[data-role='check']:checked").length ? $("[data-role='batch']").addClass("fn-btn-disabled") : $("[data-role='batch']").removeClass("fn-btn-disabled")
    }), delegate.on("change", '[data-role="check"]', function() {
        $("[data-role='subCheck']").prop("checked", $("[data-role='check']:checked").length == $("[data-role='check']").length), 0 == $("[data-role='check']:checked").length ? $("[data-role='batch']").addClass("fn-btn-disabled") : $("[data-role='batch']").removeClass("fn-btn-disabled")
        ...
        if (!$(this).hasClass("fn-btn-disabled")) {
            ...
            }), caseIds = caseidArray.join(","), batchId ? new Ajax({
