"use strict";
define("src/bus/account/mySuit/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/delegate-debug", "model/filterConditions/main-debug", "model/modal/main-debug", "model/countDown/main-debug", "common/dialog-debug", "common/domUtil-debug", "common/handlerbars-debug", "model/searchList/main-debug", "model/ajax/main-debug", "common/statusMap-debug"], function(require, exports, module) {
    require("bus/global/main-debug");
    var $ = require("common/jquery-debug"),
        delegate = (require("common/util-debug"), require("common/delegate-debug")),
    ...
    dialogExp.after("hide", function() {
        ...
        return window.open("/account/mySuitRpc/derivedDataToExcel.json?filterMap=" + param.filterMap)
    })
});
"use strict";
