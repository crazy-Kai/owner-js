"use strict";
define("src/bus/account/litigationBill/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/delegate-debug", "common/calendar-debug", "model/searchList/main-debug", "model/ajax/main-debug", "model/modal/main-debug", "common/validator-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "common/statusMap-debug"], function(require, exports, module) {
    ...
    var c1, c2, $ = require("common/jquery-debug"),
        ...
        Validator = (require("model/ajax/main-debug"), require("model/modal/main-debug"), require("common/validator-debug")),
        util = require("common/util-debug");
    require("common/handlerbars-debug");
    if ($("#submit-date-fr").length) {
        var data = new Date,
            pass = util.formatData("yyyy-MM-dd", new Date(data.getFullYear(), data.getMonth() - 3, data.getDate())),
            today = util.formatData("yyyy-MM-dd", data);
        c1 = new Calendar({
            ...
            range: [pass, null]
        }), attachSelectDateEvent(c1, c2, 1), $("#submit-date-fr").val(pass), $("#submit-date-to").val(today)
    }
    var statusMap = require("common/statusMap-debug"),
