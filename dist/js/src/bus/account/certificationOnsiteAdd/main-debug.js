"use strict";
define("src/bus/account/certificationOnsiteAdd/main-debug", ["common/jquery-debug", "common/validator-debug", "common/calendar-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "model/upload/main-debug", "model/ajax/main-debug"], function(require, exports, module) {
    var $ = require("common/jquery-debug"),
        Validator = require("common/validator-debug"),
        Calendar = require("common/calendar-debug"),
        Upload = (require("common/util-debug"), require("model/upload/main-debug")),
        Ajax = require("model/ajax/main-debug"),
        validatorExp = Validator.use("#certificationOnsiteAdd-form");
    new Calendar({
    ...
    $submitBtn.on("click", function() {
        validatorExp.execute(function(err, errList, element) {
            ...
            if (err) {
                ...
                if ("normal" === type ? errList.forEach(function(item, index) {
                        item[0] && "fileLicenseIds" !== item[2].attr("id") && (pass = !1)
                    }) : "legal" === type && errList.forEach(function(item, index) {
                        item[0] && "fileFrontIds" !== item[2].attr("id") && "fileBackIds" !== item[2].attr("id") && (pass = !1)
                    }), pass) {
                    new Ajax({
        ...
        $(".item-normal").addClass("fn-hide").children().addClass("fn-hide"), $(".item-legal").removeClass("fn-hide").children().removeClass("fn-hide")
    }), $(".cert-normal").on("click", function() {
        $(".item-legal").addClass("fn-hide").children().addClass("fn-hide"), $(".item-normal").removeClass("fn-hide").children().removeClass("fn-hide")
    })
});
"use strict";
