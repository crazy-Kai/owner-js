"use strict";
define("src/bus/paymentorder/court/divisionCase/casesReview/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/ajax/main-debug"], function(require, exports, module) {
    ...
    $('[data-role="reviewConclusion"]').on("change", function() {
        "agree" == $(this).val() ? ($(".JS-trigger-click-save").val("生成支付令"), $('[data-role="reason"]').val(""), $('[data-role="reason"]').addClass("fn-hide"), $('[data-role="not_accepted_condition"]').val(""), $("#not_accepted_condition_div").addClass("fn-hide")) : ($(".JS-trigger-click-save").val("驳回申请"), $('[data-role="reason"]').removeClass("fn-hide"))
    }), $('[data-role="reason"]').on("change", function() {
        "pm_reject_reason_5" == $(this).val() ? $("#not_accepted_condition_div").removeClass("fn-hide") : ($('[data-role="not_accepted_condition"]').val(""), $("#not_accepted_condition_div").addClass("fn-hide"))
        ...
        new Ajax({
            ...
            "agree" == $('[data-role="reviewConclusion"]').val() ? setTimeout(domUtil.redirect("/paymentorder/court/divisionCase/paymentOrderSend.htm?securityCaseId=" + $("input[name='securityCaseId']").val()), 3e3) : setTimeout(location.reload(), 3e3)
        }).submit()
    })
});
"use strict";
