"use strict";
define("src/bus/paymentorder/court/divisionCase/payment/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/tinymce-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/modal/main-debug", "model/ajax/main-debug"], function(require, exports, module) {
    ...
    $('[data-role="edit"]').on("click", function() {
        "编辑支付令" == $(this).html() ? ($(this).html("保存支付令"), tinymceUse({
            selector: "#content"
        }), $("#edit-payment").removeClass("fn-hide"), $("#view-payment").addClass("fn-hide")) : ($("#content").val(tinymce.get("content").getContent()), new Ajax({
        ...
        Modal.confirm("提醒", "是否确认发送？", function() {
            $("#edit-payment").hasClass("fn-hide") ? new Ajax({
                request: "/paymentorder/paymentOrderRpc/sendPaymentOrderDo.json?securityCaseId=" + $("input[name='securityCaseId']").val(),
                autoSuccessAlert: !0
            }).on("ajaxSuccess", function(rtv, msg, con) {
                setTimeout(domUtil.redirect("/paymentorder/court/divisionCase/sendConfirm.htm?securityCaseId=" + $("input[name='securityCaseId']").val()), 3e3)
            }).submit() : ($("#content").val(tinymce.get("content").getContent()), new Ajax({
                request: "/paymentorder/paymentOrderRpc/updatePaymentOrderDo.json",
                paramName: "lassenPaymentOrderDo",
                parseForm: $("#payment-form")
            }).on("ajaxSuccess", function(rtv, msg, con) {
