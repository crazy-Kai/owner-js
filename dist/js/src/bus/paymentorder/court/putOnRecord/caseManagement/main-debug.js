"use strict";
define("src/bus/paymentorder/court/putOnRecord/caseManagement/main-debug", ["bus/global/main-debug", "common/jquery-debug", "model/caseManagement/main-debug"], function(require, exports, module) {
    require("bus/global/main-debug");
    var caseManagement = (require("common/jquery-debug"), require("model/caseManagement/main-debug")),
        multiple = {
