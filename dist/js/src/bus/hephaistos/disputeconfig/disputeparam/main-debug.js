"use strict";
define("src/bus/hephaistos/disputeconfig/disputeparam/main-debug", ["src/bus/hephaistos/disputeconfig/disputeconfig/disputeEdit-debug", "common/jquery-debug", "common/myWidget-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "src/bus/hephaistos/disputeconfig/disputeconfig/useTpl-debug", "model/modal/main-debug", "common/validator-debug", "common/handlerbars-debug", "model/selectpicker/main-debug", "model/ajax/main-debug", "model/upload/main-debug", "model/searchList/main-debug"], function(require, exports, module) {
    var Disputeconfig = require("src/bus/hephaistos/disputeconfig/disputeconfig/disputeEdit-debug"),
        SearchList = require("model/searchList/main-debug"),
        searchListExp = new SearchList({
            element: "#searchList"
        });
    new Disputeconfig({
        element: "#searchContent",
        trigger: "#addDisputeParam",
        tpl: "#tpl-disputeparam",
        paramName: "filterMap"
