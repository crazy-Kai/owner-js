"use strict";
define("src/bus/suit/common/courtAddress-debug", ["model/ajax/main-debug", "common/domUtil-debug", "common/jquery-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/address/select-debug"], function(require, exports, module) {
    var Ajax = require("model/ajax/main-debug"),
        ...
        CoutAddress = Address.extend({
            ...
            setup: function() {
                var me = this;
                me.on("change", me.incChange), CoutAddress.superclass.setup.call(me)
            },
