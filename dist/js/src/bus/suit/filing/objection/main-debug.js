"use strict";
define("src/bus/suit/filing/objection/main-debug", ["bus/global/main-debug", "common/validator-debug", "common/domUtil-debug", "common/jquery-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/modal/main-debug", "model/ajax/main-debug", "model/realTime/main-debug"], function(require, exports, module) {
    ...
    new Ajax({
        ...
        events: {
            "click .JS-trigger-click-submit": function() {
                var me = this;
                Validator.oneExecute("#objectionTable") || Modal.confirm("提示 ", "提交后无法修改，确认提交么？", function() {
                    me.submit()
                })
            }
        }
