"use strict";
define("src/bus/suit/trial/checkRules/main-debug", ["bus/global/main-debug", "bus/suit/trial/global/main-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "model/modal/main-debug"], function(require, exports, module) {
    ...
    caseId ? (url = $("#notic-check-next").attr("href"), url = url.indexOf("?") == -1 ? url + "?caseId=" + caseId : url + "&caseId=" + caseId, $("#notic-check-next").attr("href", url), url = $("#prev").attr("href"), url = url.indexOf("?") == -1 ? url + "?caseId=" + caseId : url + "&caseId=" + caseId, $("#prev").attr("href", url)) : $("#notic-check-next").click(function(e) {
