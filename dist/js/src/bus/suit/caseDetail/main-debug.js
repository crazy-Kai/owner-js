"use strict";
define("src/bus/suit/caseDetail/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/delegate-debug", "common/dialog-debug", "common/handlerbars-debug", "model/ajax/main-debug", "common/tinymce-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/scroller-debug", "model/tab/main-debug", "model/imgView/main-debug", "model/countDown/main-debug", "bus/suit/oppugn/evidenceOppugnEnd/main-debug"], function(require, exports, module) {
    function queryAndOpen(element) {
        new Ajax({
            ...
            rtv && (rtv.securityDocId = $(element.target).data("sendParam").securityDocId);
    ...
    var $ = require("common/jquery-debug"),
        ...
        Scroller = (require("common/domUtil-debug"), require("common/scroller-debug")),
        ImgView = (require("model/tab/main-debug"), require("model/imgView/main-debug")),
        evidenceOppugnNav = (require("model/countDown/main-debug"), $("#evidenceOppugnNav"));
    if (evidenceOppugnNav.length) {
        var EvidenceOppugnEnd = new require("bus/suit/oppugn/evidenceOppugnEnd/main-debug");
        new EvidenceOppugnEnd({
            fixClassName: "go-nav-fix go-nav-fix-det"
        })
    } else Scroller.use(".JS-need-scroller"), new ImgView;
