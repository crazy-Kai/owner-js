"use strict";
define("src/bus/suit/newMysuit/main-debug", ["common/jquery-debug", "common/react-debug", "common/react-dom-debug", "src/bus/suit/newMysuit/NewMysuitHead-debug", "src/bus/suit/newMysuit/NewMysuitController-debug", "common/limit-debug", "common/limit-dom-debug", "common/cookie-debug", "common/reflux-debug", "src/bus/suit/newMysuit/NewMysuitNav-debug"], function(require, exports, module) {
    var $ = require("common/jquery-debug"),
        React = require("common/react-debug"),
        ReactDOM = require("common/react-dom-debug"),
        NewMysuitHead = require("src/bus/suit/newMysuit/NewMysuitHead-debug"),
        NewMysuitNav = require("src/bus/suit/newMysuit/NewMysuitNav-debug"),
        NewMysuitController = require("src/bus/suit/newMysuit/NewMysuitController-debug"),
        NewMysuit = React.createClass({
            ...
            render: function() {
                var me = this,
                    state = me.state;
                me.props;
                return React.createElement("div", null, React.createElement(NewMysuitHead, {
                    iframeName: "newMysuitIframe"
                }), React.createElement("div", {
                    className: "sc-bodyer sc-FoSiEm12 sc-Co666",
                    ref: "body"
                }, React.createElement(NewMysuitNav, {
                    iframeName: "newMysuitIframe"
                }), React.createElement("div", {
                    ...
                    width: "100%",
                    height: "100%",
                    name: "newMysuitIframe"
                }))))
            },
            componentDidMount: function() {
                var me = this;
                8 === document.documentMode && $(me.refs.body).height(document.documentElement.clientHeight - 62)
            }
        }),
        suitContent = $("#suit-content");
    ReactDOM.render(React.createElement(NewMysuit, null), suitContent[0])
});
"use strict";
define("src/bus/suit/newMysuit/NewMysuitHead-debug", ["common/react-debug", "common/react-dom-debug", "src/bus/suit/newMysuit/NewMysuitController-debug", "common/jquery-debug", "common/limit-debug", "common/limit-dom-debug", "common/cookie-debug", "common/reflux-debug"], function(require, exports, module) {
    var React = require("common/react-debug"),
        NewMysuitController = (require("common/react-dom-debug"), require("src/bus/suit/newMysuit/NewMysuitController-debug")),
        NewMysuitHead = React.createClass({
            displayName: "NewMysuitHead",
            mixins: [NewMysuitController.Reflux.connect(NewMysuitController.Stroe)],
            getInitialState: function() {
                var state = {};
                return state.showMore = !1, state
            },
            ...
            render: function() {
                var me = this,
                    state = (me.props, me.state);
                return React.createElement("div", {
                    className: "sc-header sc-FoSiEm12 sc-Co666"
                }, React.createElement("div", {
                    className: "ch-logo sc-left"
                }), React.createElement("div", {
                    className: "ch-title sc-MaTo20 sc-left"
                }, state.head.title), React.createElement("div", {
                    className: "ch-person sc-MaRi20 sc-MaTo20 sc-right"
                }, React.createElement("a", {
                    href: state.indexLink,
                    className: "sc-link-white"
                }, "网上法庭首页"), React.createElement("span", {
                    className: "sc-CoFFF sc-MaLe20 sc-MaRi20"
                }, "|"), React.createElement("a", {
                    href: "javascript:;",
                    onMouseEnter: me.mouseEnterHandle,
                    className: "sc-link-white"
                }, state.head.person, React.createElement("i", {
                    className: "ch-icon"
                })), React.createElement("ul", {
                    className: "ch-list" + (state.showMore ? "" : " sc-hide"),
                    onMouseEnter: me.mouseEnterHandle,
                    onMouseLeave: me.mouseLeaveHandle
                }, React.createElement("li", null, state.head.person, React.createElement("i", {
                    className: "ch-icon"
                })), state.head.personCenterUrl && React.createElement("li", null, React.createElement("a", {
                ...
                }, "个人资料")), React.createElement("li", null, React.createElement("a", {
                    href: "javascript:;",
                    className: "sc-link-lightblack",
                    onClick: NewMysuitController.Actions.loginOut
                }, "退出系统")))))
            }
        });
...
"use strict";
define("src/bus/suit/newMysuit/NewMysuitNav-debug", ["common/react-debug", "common/react-dom-debug", "common/limit-debug", "common/limit-dom-debug", "src/bus/suit/newMysuit/NewMysuitController-debug", "common/jquery-debug", "common/cookie-debug", "common/reflux-debug"], function(require, exports, module) {
    var React = require("common/react-debug"),
        limit = (require("common/react-dom-debug"), require("common/limit-debug")),
        NewMysuitController = require("src/bus/suit/newMysuit/NewMysuitController-debug"),
        NewMysuitNav = React.createClass({
            displayName: "NewMysuitNav",
            mixins: [NewMysuitController.Reflux.connect(NewMysuitController.Stroe)],
            render: function() {
                var me = this,
                    state = me.state,
                    propsNavMap = (me.props, state.navMap),
                    propsNav = state.nav;
                return document.title = propsNavMap[state.navKey] || state.navKey || "", React.createElement("div", {
                    className: "sc-nav sc-left"
                }, React.createElement("dl", {
                    className: "sc-MaTo10"
                }, limit.map(propsNav, function(val, index) {
                    return limit.map(val, function(val, key) {
                        return key ? React.createElement("dd", {
                            key: key
                        }, React.createElement("a", {
                            target: "true" === val.isForward ? "_blank" : state.iframeName,
                            ref: index || 1 !== key ? null : "first",
                            href: val.val,
                            onClick: NewMysuitController.Actions.targetNav,
                            className: state && state.navKey === val.key ? "ch-active" : "",
                            "data-key": val.key
                        }, propsNavMap[val.key])) : React.createElement("dt", {
                            key: key
                        }, propsNavMap[val.key])
                    })
                })))
...
define("common/react-dom-debug", ["common/react-debug"], function(require, exports, module) {
    ! function(f) {
