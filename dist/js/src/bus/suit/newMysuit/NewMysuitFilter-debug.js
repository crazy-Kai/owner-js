"use strict";
define("src/bus/suit/newMysuit/NewMysuitFilter-debug", ["common/react-debug", "common/react-dom-debug", "-debug"], function(require, exports, module) {
    var React = require("common/react-debug"),
        NewMysuitFilter = (require("common/react-dom-debug"), require("-debug"), React.createClass({
            displayName: "NewMysuitFilter",
            render: function() {
                return React.createElement("div", {
                    className: "sc-filter sc-MaTo30 sc-MaLe20 sc-LiHeEm25"
                }, "关键词", React.createElement("input", {
                    type: "text",
                    className: "sc-input sc-MaLe10 sc-MaRi10"
                }), React.createElement("a", {
                    href: "javscript:;",
                    className: "sc-link-blue"
                }, "高级查询", React.createElement("i", {
                    className: "ch-icon sc-MaLe5"
                })))
            }
        }));
