"use strict";
define("src/bus/suit/start/copyright/prosecute/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/domUtil-debug", "common/handlerbars-debug", "common/delegate-debug", "model/modal/main-debug", "model/ajax/main-debug", "common/validator-debug", "model/perChecked/main-debug"], function(require, exports, module) {
    function isOverFlow() {
        var amount = 0,
            msg = null;
    ...
    new PerChecked({
        ...
        if (flag && !Validator.oneExecute("#page-allinfo", ".JS-prosecute-required")) {
            var msg = isOverFlow();
    ...
    delegate.on("change", '[name="complaint"]', function() {
        "y" === this.value ? (domUtil.hide(pageOrder), domUtil.hide(pageAllinfo), domUtil.hide(pageCheck)) : (domUtil.show(pageOrder), Ajax.getWidget("#selectionOrder").get("soHasOrder") && (domUtil.show("#page-allinfo"), domUtil.show("#page-check")))
