"use strict";
define("src/bus/suit/start/success/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug"], function(require, exports, module) {
    require("bus/global/main-debug");
    var $ = require("common/jquery-debug"),
        domUtil = require("common/domUtil-debug"),
        securityCaseId = $("#securityCaseId");
    setTimeout(function() {
        domUtil.redirect("/suit/start/mediationStatus.htm?securityCaseId=" + securityCaseId.val())
    }, 3e3)
});
"use strict";
