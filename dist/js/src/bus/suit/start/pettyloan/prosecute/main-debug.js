"use strict";
define("src/bus/suit/start/pettyloan/prosecute/main-debug", ["bus/global/main-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/domUtil-debug", "common/jquery-debug", "common/handlerbars-debug", "model/ajax/main-debug", "model/modal/main-debug", "common/validator-debug", "model/perChecked/main-debug"], function(require, exports, module) {
    function isOverFlow() {
        var amount = 0,
            msg = null;
    ...
    function formValidator() {
        var flag;
        return vaExp && vaExp.destroy(), vaExp = Validator.use("#page-table", ".JS-prosecute-required"), vaExp.addItem({
