...
define("src/bus/courtmanage/courtmanage/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/cookie-debug", "common/myWidget-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/modal/main-debug", "model/ajax/main-debug", "model/perSearch/main-debug", "src/bus/courtmanage/common/coutAddress-debug", "model/address/select-debug", "common/validator-debug", "src/bus/courtmanage/common/tpl-debug", "model/selectpicker/main-debug", "model/multiple/main-debug", "model/upload/main-debug"], function(require, exports, module) {
                ...
                events: {
                    'click [data-role="submit"]': function(e) {
                        ...
                        me.validatorExe.execute(function(err) {
                            err || (data.title && "y" == me.$('[name="isDocking"]:checked').val() ? Modal.confirm("提醒", "确定该法院同步通达海？", function() {
                                me.dataPost()
                            }) : me.dataPost())
                        })
                    }
    ...
    var search, $ = require("common/jquery-debug"),
        ...
        Tpl = (require("common/validator-debug"), require("src/bus/courtmanage/common/tpl-debug")),
        coutAddressExp = new CoutAddress({
            ...
            'click [data-role="delete"]': function(e) {
                Modal.confirm("提示", "您确定要删除吗？", function() {
                    new Ajax({
                        ...
                        coutAddressExp.incChange(), Modal.alert(1, msg)
                    }).submit()
                })
            }
        }
