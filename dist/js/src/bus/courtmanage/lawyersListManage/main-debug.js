"use strict";
define("src/bus/courtmanage/lawyersListManage/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/cookie-debug", "common/delegate-debug", "common/dialog-debug", "common/myWidget-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/modal/main-debug", "common/validator-debug", "common/calendar-debug", "model/ajax/main-debug", "model/upload/main-debug", "model/perSearch/main-debug", "src/bus/courtmanage/common/firmAddress-debug", "model/address/select-debug", "src/bus/courtmanage/common/tpl-debug", "model/selectpicker/main-debug", "model/multiple/main-debug"], function(require, exports, module) {
        ...
        return new Tpl({
            ...
            onAddressChange: function(id) {
                ...
                new Ajax({
                    ...
                    })), me.checkSelect(), me.$('[name="securityFirmId"]').trigger("change")
                }).submit()
            },
            onComplete: function() {
                var me = this;
                me.calendar = new Calendar({
                    trigger: me.$('[name="startWorkTime"]')
                })
            },
            ...
            events: {
                'click [data-role="triggleSure"]': function(e) {
                    ...
                    new Ajax({
                        ...
                        me.hide(), Modal.alert(1, msg, function() {
    ...
    var search, $ = require("common/jquery-debug"),
        ...
        FirmAddress = require("src/bus/courtmanage/common/firmAddress-debug"),
        Tpl = require("src/bus/courtmanage/common/tpl-debug"),
        paramName = $('[name="name"]'),
        focusParamName = ($('[name="firmId"]'), !1);
    new FirmAddress({
        defaultFirmId: cookie.get("firmId"),
        defaultFocus: cookie.get("areaCode"),
        onFirmChange: function(areaCode, firmId) {
            search ? (focusParamName = !1, search.searchListReload(), cookie.set("areaCode", areaCode), cookie.set("firmId", firmId)) : search = new PerSearch({
                element: "#search-list",
                onAjaxSuccess: function() {
    ...
    Validator.use("#excel");
    Calendar.use(), new(MyWidget.extend({
        attrs: {
            element: "body"
        },
        events: {
            ...
            'click [data-role="search"]': function(e) {
                focusParamName = !0, search.searchListReload()
            },
            'keypress [name="name"]': function(e) {
                13 === e.charCode && (focusParamName = !0, search.searchListReload())
            },
            'click [data-role="delete"]': function(e) {
                Modal.confirm("提示", "您确定要删除吗？", function() {
                    new Ajax({
                        ...
                        search.searchListAjax(), Modal.alert(1, msg)
                    }).submit()
                })
            }
        }
        ...
        exceTpl().after("show", function() {
            ...
            Upload.use(me.$('[data-widget="upload"]'), {
                onSuccess: function(res) {
                    var me = this;
                    me.get("parentNode").find('[name="securityId"]').val(res.comments), me.element.html(res.fileName)
                }
            })
        ...
        Dialog.showTemplate("#photo", null, {
            width: 450,
            autoShow: !1
        }).after("show", function() {
            var me = this;
            Upload.use(me.$('[data-widget="upload"]'), {
                onSuccess: function(res) {
                    me.hide(), search.searchListReload()
                }
            })
        }).before("hide", function() {
            Upload.remove(this.$('[data-widget="upload"]'))
...
"use strict";
define("src/bus/courtmanage/common/firmAddress-debug", ["model/ajax/main-debug", "common/domUtil-debug", "common/jquery-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/address/select-debug"], function(require, exports, module) {
    var Ajax = require("model/ajax/main-debug"),
        domUtil = require("common/domUtil-debug"),
        Address = require("model/address/select-debug"),
        FirmAddress = Address.extend({
            ...
            initProps: function() {
                var me = this;
                me.firmId = me.$('[name="firmId"]'), me.areaCode = me.$('[name="areaCode"]')
            },
            setup: function() {
                var me = this;
                me.on("change", me.get("isEncrypt") ? me.incEncryoeChange : me.incChange), FirmAddress.superclass.setup.call(me)
            },
            incEncryoeChange: function(id) {
                var me = this;
                me.areaCode.val(id), new Ajax({
                    request: "/courtmanage/firmManageRpc/getFirmByAreaCode.json",
                    param: {
                        areaCode: id
                    }
                    ...
                    })), me.firmId.val(me.get("defaultFirmId")), me.set("defaultFirmId", ""), me.trigger("firmChange", me.areaCode.val(), me.firmId.val())
                }).submit()
            },
...
"use strict";
define("src/bus/courtmanage/common/tpl-debug", ["common/jquery-debug", "common/myWidget-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/modal/main-debug", "common/validator-debug", "model/selectpicker/main-debug", "model/address/select-debug", "model/ajax/main-debug", "model/multiple/main-debug", "model/upload/main-debug"], function(require, exports, module) {
    var $ = require("common/jquery-debug"),
        MyWidget = require("common/myWidget-debug"),
        Modal = (require("common/domUtil-debug"), require("common/util-debug"), require("model/modal/main-debug")),
        Validator = require("common/validator-debug"),
        Handlerbars = require("common/handlerbars-debug"),
        Address = (require("model/selectpicker/main-debug"), require("model/address/select-debug")),
        Ajax = require("model/ajax/main-debug"),
        Multiple = require("model/multiple/main-debug"),
        Upload = require("model/upload/main-debug"),
        courtmanageTpl = MyWidget.extend({
            ...
            setup: function() {
                var me = this;
                me.dialog = Modal.show(me.element, {
                    width: 650
                }).before("hide", function() {
                    me.destroy()
                }), Upload.use(me.$('[data-widget="upload"]'));
                ...
                address.length && (me.address = new Address({
                    ...
                    onChange: function(id) {
                        me.$('[name="areaCode"]').val(id), me.trigger("addressChange", id)
                    }
                }));
                ...
                })), me.checkSelect(), me.trigger("complete")
            },
            destroy: function() {
                var me = this;
                return Upload.dead(me.$('[data-widget="upload"]')), me.address && me.address.destroy(), me.multiple && me.multiple.destroy(), courtmanageTpl.superclass.destroy.call(me), me
            },
            dataPost: function() {
                var me = this;
                return new Ajax({
                    ...
                    me.trigger("ajaxSuccess", val, response), Modal.alert(1, msg), me.dialog.hide()
                }).submit(), me
            },
            checkSelect: function() {
                ...
                me.$("[data-value]").each(function() {
                    ...
                    value && (self.val(value), null === self.val() && self.val(""))
                })
            }
        });
