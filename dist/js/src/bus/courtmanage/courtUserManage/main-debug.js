"use strict";
define("src/bus/courtmanage/courtUserManage/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/cookie-debug", "common/myWidget-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/modal/main-debug", "model/ajax/main-debug", "model/perSearch/main-debug", "src/bus/courtmanage/common/coutAddress-debug", "model/address/select-debug", "src/bus/courtmanage/common/tpl-debug", "common/validator-debug", "model/selectpicker/main-debug", "model/multiple/main-debug", "model/upload/main-debug"], function(require, exports, module) {
        ...
        return new Tpl({
            ...
            events: {
                'change [name="courtId"]': function(e) {
                    ...
                    Ajax.when({
                        ...
                        })), me.checkSelect(), me.$("[data-value]").removeAttr("data-value");
                        var isDocking = docking.val.isDocking;
                        "y" == isDocking ? me.$("#courtSystemAccountTr").removeClass("fn-hide") : (me.$("#courtSystemAccount").val(""), me.$("#courtSystemAccountTr").addClass("fn-hide"))
                    }, function(rs1, rs2) {})
                }
            },
            ...
            onAddressChange: function(id) {
                ...
                new Ajax({
                    ...
                    })), me.checkSelect(), me.$('[name="courtId"]').trigger("change")
                }).submit()
            }
        })
    }
    ...
    var search, $ = require("common/jquery-debug"),
        ...
        CoutAddress = require("src/bus/courtmanage/common/coutAddress-debug"),
        Tpl = require("src/bus/courtmanage/common/tpl-debug"),
        paramName = $('[name="paramName"]'),
        focusParamName = ($('[name="courtId"]'), !1);
    new CoutAddress({
        defaultCourtId: cookie.get("courtId"),
        defaultFocus: cookie.get("areaCode"),
        onCourtChange: function(areaCode, courtId) {
            search ? (focusParamName = !1, search.searchListReload(), cookie.set("areaCode", areaCode), cookie.set("courtId", courtId)) : search = new PerSearch({
                element: "#search-list",
                onAjaxSuccess: function() {
...
"use strict";
define("src/bus/courtmanage/common/coutAddress-debug", ["model/ajax/main-debug", "common/domUtil-debug", "common/jquery-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/address/select-debug"], function(require, exports, module) {
    var Ajax = require("model/ajax/main-debug"),
        domUtil = require("common/domUtil-debug"),
        Address = require("model/address/select-debug"),
        CoutAddress = Address.extend({
            ...
            initProps: function() {
                var me = this;
                me.courtId = me.$('[name="courtId"]'), me.areaCode = me.$('[name="areaCode"]')
            },
            setup: function() {
                var me = this;
                me.on("change", me.get("isEncrypt") ? me.incEncryoeChange : me.incChange), CoutAddress.superclass.setup.call(me)
            },
            incEncryoeChange: function(id) {
                ...
                me.areaCode.val(id), new Ajax({
                    ...
                    })), me.courtId.val(me.get("defaultCourtId")), me.set("defaultCourtId", ""), me.trigger("courtChange", me.areaCode.val(), me.courtId.val())
                }).submit()
            },
