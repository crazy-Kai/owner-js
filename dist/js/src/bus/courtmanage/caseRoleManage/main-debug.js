...
define("src/bus/courtmanage/caseRoleManage/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/cookie-debug", "common/myWidget-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/modal/main-debug", "model/ajax/main-debug", "model/perSearch/main-debug", "src/bus/courtmanage/common/coutAddress-debug", "model/address/select-debug", "common/dialog-debug"], function(require, exports, module) {
    ...
    function reloadRoleMange() {
        reloadEvent && reloadDialog && (reloadDialog.hide(), getRoleMange(reloadEvent))
    }
    ...
    var search, $ = require("common/jquery-debug"),
        ...
        Ajax = (require("common/domUtil-debug"), require("model/modal/main-debug"), require("model/ajax/main-debug")),
