...
define("src/bus/courtmanage/courtRoom/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/cookie-debug", "common/myWidget-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/modal/main-debug", "model/ajax/main-debug", "model/perSearch/main-debug", "src/bus/courtmanage/common/coutAddress-debug", "model/address/select-debug", "src/bus/courtmanage/common/tpl-debug", "common/validator-debug", "model/selectpicker/main-debug", "model/multiple/main-debug", "model/upload/main-debug"], function(require, exports, module) {
    ...
    new CoutAddress({
        ...
        onCourtChange: function(areaCode, courtId) {
            search ? (search.searchListReload(), cookie.set("areaCode", areaCode), cookie.set("courtId", courtId)) : search = new PerSearch({
                element: "#search-list"
            })
        }
    }), new(MyWidget.extend({
        ...
        events: {
            ...
            'click [data-role="editor"]': function(e) {
                new Ajax({
                    request: "/courtmanage/courtRoomRpc/gerCourtRoomBySecId.json",
            ...
            'click [data-role="delete"]': function(e) {
                Modal.confirm("提示", "您确定要删除吗？", function() {
                    new Ajax({
                        request: "/courtmanage/courtRoomRpc/deleteCourtRoom.json",
                        param: $(e.target).data("param")
