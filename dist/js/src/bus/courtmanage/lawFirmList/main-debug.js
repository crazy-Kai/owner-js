"use strict";
define("src/bus/courtmanage/lawFirmList/main-debug", ["bus/global/main-debug", "common/jquery-debug", "common/cookie-debug", "common/myWidget-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/modal/main-debug", "model/ajax/main-debug", "model/perSearch/main-debug", "src/bus/courtmanage/common/firmAddress-debug", "model/address/select-debug", "src/bus/courtmanage/common/tpl-debug", "common/validator-debug", "model/selectpicker/main-debug", "model/multiple/main-debug", "model/upload/main-debug"], function(require, exports, module) {
    ...
    var search, $ = require("common/jquery-debug"),
        ...
        Modal = (require("common/domUtil-debug"), require("model/modal/main-debug")),
        ...
        focusParamName = ($('[name="firmName"]'), !1),
        firmAddressExp = new FirmAddress({
            defaultFirmId: cookie.get("firmId"),
            defaultFocus: cookie.get("areaCode"),
            onFirmChange: function(areaCode, firmId) {
                search ? (search.searchListReload(), cookie.set("areaCode", areaCode), cookie.set("firmId", firmId)) : search = new PerSearch({
                    element: "#search-list"
                })
            }
        });
            ...
            'click [data-role="delete"]': function(e) {
                Modal.confirm("提示", "您确定要删除吗？", function() {
                    new Ajax({
                        ...
                        firmAddressExp.incChange(), Modal.alert(1, msg)
                    }).submit()
                })
            }
        }
