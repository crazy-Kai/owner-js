...
function getLoadMore(parent, options) {
    ...
    context[name] = context[name] || definition(), "undefined" != typeof module && module.exports ? module.exports = context[name] : "function" == typeof define && define.amd && define("src/bus/openservice/qd/index_bnk-debug", [], function() {
        return context[name]
    })
...
url = "/openservice/qiandunRpc/queryLegalCaseDtoList.json", userId = session("userId") || "3680010221", timeStamp = session("timeStamp"), expire = 6e5, isExpired = !0, pop = window.PopWin && window.PopWin(), attrToMerge = ["content", "data"], unfinishedOptions = {
    paramName: "filterMap",
    status: "unfinished",
    length: 10,
    begin: 0
}, timeStamp && (isExpired = Date.now() - timeStamp > expire), userId ? (unfinishedOptions.havanaId = userId, renderAll(url, unfinishedOptions)) : window.WindVane.call("WVNative", "get_user_info", {}, function(data) {
