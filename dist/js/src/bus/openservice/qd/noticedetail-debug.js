define("src/bus/openservice/qd/noticedetail-debug", ["src/bus/openservice/qd/noticedetail-hbs-debug", "common/handlerbars-debug", "common/jQuery-debug", "common/calendar-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "model/perSearch/main-debug"], function(require, exports, module) {
    var TEMPLATE = require("src/bus/openservice/qd/noticedetail-hbs-debug"),
        $ = require("common/jQuery-debug"),
        calendar = require("common/calendar-debug"),
        util = require("common/util-debug"),
        DOWN_URL = "/aeolus/lassenPushDetailRpc/exportPushDetail.json",
