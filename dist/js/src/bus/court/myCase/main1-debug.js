"use strict";
define("src/bus/court/myCase/main1-debug", ["bus/global/main-debug", "common/jquery-debug", "common/delegate-debug", "model/countDown/main-debug", "common/calendar-debug", "model/searchList/main-debug", "model/ajax/main-debug", "model/modal/main-debug", "common/validator-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/statusMap-debug"], function(require, exports, module) {
    ...
    var $ = require("common/jquery-debug"),
        ...
        util = (require("common/validator-debug"), require("common/util-debug")),
        c1 = new Calendar({
    ...
    $("#search").on("click", function() {
        ...
        $(":reset").trigger("click"), $("#submit-date-fr, #submit-date-to, #register-date-fr, #register-date-to, #judge-date-fr, #judge-date-to").prop("disabled", "")
    }), $("input[name='orderBy_']").on("click", function() {
        $("[type='radio']").parent().removeClass("fn-btn fn-btn-default fn-btn-mi"), $("[type='radio']").parent().addClass("global-link"), $("[type='radio']:checked").parent().removeClass("global-link"), $("[type='radio']:checked").parent().addClass("fn-btn fn-btn-default fn-btn-mi"), $("#orderBy").val($("[type='radio']:checked").val()), doSearch()
