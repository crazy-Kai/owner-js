! function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("src/assets/js/echarts-debug.min", [], e) : "object" == typeof exports ? exports.echarts = e() : t.echarts = e()
}(this, function() {
    return function(t) {
        function e(n) {
            ...
            e[i ? "eachComponent" : "eachSeries"](function(t, r) {
                ...
                if (!l) {
                    var h = _.parseClassType(r.type),
                        u = i ? b.getClass(h.main, h.sub) : S.getClass(h.sub);
                    if (!u) return;
        ...
        }, z.setTheme = function() {}, z.getModel = function() {
            return this._model
            ...
            D(O, function(e) {
                t.on(e, function(t) {
                    ...
                    if (n && null != n.dataIndex) {
                        var a = n.hostModel || i.getSeriesByIndex(n.seriesIndex),
        ...
        l.createNameEach = function(t, e) {
            ...
            return o.isObject(t) && t.id && 0 === (t.id + "").indexOf("\0_ec_\0")
        }, t.exports = l
    }, function(t, e, i) {
        "use strict";
        ...
        }), s.enableSubTypeDefaulter(u), s.enableTopologicalTravel(u, n), o.mixin(u, i(115)), t.exports = u
    }, function(t, e, i) {
        "use strict";
            ...
            brush: function(t) {
                ...
                if (e = "string" == typeof n ? this._image : n, !e && n) {
                    ...
                    if (!a) return e = new Image, e.onload = function() {
                        ...
                        image: e,
                        pending: [this]
                    }, e.src = n, l.put(n, a), void(this._image = e);
        ...
        u._updateCommon = function(t, e, i) {
            ...
            for (var x, _ = s.getModel(f), w = s.getModel(p), b = a.style, S = t.dimensions.slice(), M = S.pop();
                "ordinal" === (x = t.getDimensionInfo(M).type) || "time" === x;) M = S.pop();
            ...
            if (x) {
                ...
                if (!L) {
                    ...
                    var H = function(t, e) {
                            ...
                            if (0 !== n)
                                if (R = (e - I[i]) / n, v)
                                    if (V = T[i], O = T[0 === i ? i : i - 1], N = T[i > x - 2 ? x - 1 : i + 1], B = T[i > x - 3 ? x - 1 : i + 2], b) u(O, V, N, B, R, R * R, R * R * R, d(t, a), A);
                                    else {
                                        var l;
                                        if (S) l = u(O, V, N, B, R, R * R, R * R * R, W, 1), l = f(W);
                                        else {
                                            if (M) return r(V, N, R);
                            ...
                            else if (b) s(T[i], T[i + 1], R, d(t, a), A);
                            else {
                                var l;
                                if (S) s(T[i], T[i + 1], R, W, 1), l = f(W);
                                else {
        ...
        r.prototype = {
            ...
            getBoundingRect: function() {
                if (!this._rect) {
                    var t = this.style,
                        e = o.getBoundingRect(t.text + "", t.textFont || t.font, t.textAlign, t.textBaseline);
        ...
        t.exports = y.extend({
            ...
            render: function(t, e, i) {
                var o = t.coordinateSystem,
                    ...
                    b = s(o, l),
                    S = t.get("showSymbol"),
                    M = S && !p && !t.get("showAllSymbol") && this._getSymbolIgnoreFunc(l, o),
                    A = this._data;
        ...
        t.exports = function(t, e, i, n) {
            ...
            l.each(function(i) {
                var n, a, c, d, f = l.getItemLayout(i),
                    ...
                    w = Math.cos(_),
                    b = Math.sin(_);
                if (r = f.cx, s = f.cy, "center" === m) n = f.cx, a = f.cy, d = "center";
                else {
        ...
        var o = i(1),
            ...
            d = function(t, e) {
                return !t || !e.coord || null != e.x && null != e.y || t.containData(e.coord)
            },
            f = function(t, e, i, n) {
        ...
        function r(t, e) {
            ...
            p(e, function(t, e) {
                ...
                var n = t.exist,
                    ...
                    o = t.keyInfo;
                if (x(a)) {
                    if (o.name = null != a.name ? a.name + "" : n ? n.name : "\0-", n) o.id = n.id;
                    else if (null != a.id) o.id = a.id + "";
                    else {
                        var r = 0;
                        do o.id = "\0" + o.name + "\0" + r++; while (i[o.id])
                    }
                    i[o.id] = t
                }
            })
        ...
        var u = i(42),
            ...
            v = function(t, e, i) {
                ...
                if (a && (a["-webkit-tap-highlight-color"] = "transparent", a["-webkit-user-select"] = "none", a["user-select"] = "none", a["-webkit-touch-callout"] = "none", t.innerHTML = ""), this.storage = e, n) {
                    ...
                    this._domRoot = l;
                    var h = l.style;
                    h.position = "relative", h.overflow = "hidden", h.width = this._width + "px", h.height = this._height + "px",
                        t.appendChild(l), this._layers = {}, this._zlevelList = []
                }
            ...
            g = {
                formatTooltip: function(t) {
                    var e = this._data,
                        ...
                        n = o.isArray(i) ? o.map(i, u).join(", ") : u(i),
                        a = e.getName(t);
        ...
        o.defaults(g, l.dataFormatMixin), i(2).extendComponentView({
            ...
            _renderSeriesML: function(t, e, i, n) {
                function r(e, i, a, o, r) {
                    var l, c = e.getItemModel(i),
                        d = c.get("x"),
                        f = c.get("y");
                    if (null != d && null != f) l = [h.parsePercent(d, n.getWidth()), h.parsePercent(f, n.getHeight())];
                    else {
                        if (t.getMarkerPosition) l = t.getMarkerPosition(e.getValues(e.dimensions, i));
                        else {
                            var p = e.get(m[0], i),
                                g = e.get(m[1], i);
                            l = s.dataToPoint([p, g])
                ...
                o.isArray(_) || (_ = [_, _]), "number" == typeof w && (w = [w, w]), p.from.each(function(t) {
                    ...
                    }), x.setItemLayout(t, [v.getItemLayout(t), y.getItemLayout(t)])
        ...
        var a = i(38),
            ...
            f = {
                ...
                formatTooltip: function(t) {
                    var e = this.getData(),
                        i = this.getRawValue(t),
                        n = o.isArray(i) ? o.map(i, h).join(", ") : h(i),
                        a = e.getName(t);
        ...
        o.defaults(f, s.dataFormatMixin), i(2).extendComponentView({
            ...
            _renderSeriesMP: function(t, e, i) {
                ...
                o.mixin(e, f), e.setData(d), d.each(function(n) {
                    var a, o = d.getItemModel(n),
                        s = o.getShallow("x"),
                        u = o.getShallow("y");
                    if (null != s && null != u) a = [l.parsePercent(s, i.getWidth()), l.parsePercent(u, i.getHeight())];
                    else if (t.getMarkerPosition) a = t.getMarkerPosition(d.getValues(d.dimensions, n));
                    else if (r) {
                        var c = d.get(p[0], n),
                            f = d.get(p[1], n);
                        a = r.dataToPoint([c, f])
        ...
        var h = i(1),
            ...
            v = u.asc;
        i(174);
        var y = "\0_ec_\0toolbox-dataZoom_";
        n.defaultOption = {
            show: !0,
            icon: {
        ...
        i(197), i(198), i(2).registerAction({
            type: "showTip",
            event: "showTip",
            update: "none"
        ...
        var l = i(1),
            ...
            f = c.toCamelCase,
            p = ["", "-webkit-", "-moz-", "-o-"],
            g = "position:absolute;display:block;border-style:solid;white-space:nowrap;";
        r.prototype = {
            constructor: r,
            enterable: !0,
            update: function() {
            ...
            _tryShow: function(t) {
                ...
                if (i)
                    if (this._lastX = t.offsetX, this._lastY = t.offsetY, e && null != e.dataIndex) {
                        var r = e.hostModel || a.getSeriesByIndex(e.seriesIndex),
                            s = e.dataIndex,
        ...
        var i = {
            retrieveTargetInfo: function(t, e) {
                if (t && "treemapZoomToNode" === t.type) {
                    ...
                    return null != a && (n = i.getNodeById(a)) ? {
                        node: n
                    } : null
                }
            }
                ...
                completeVisualOption: function() {
                    ...
                    function i(t) {
                        ...
                        f(this.stateList, function(o) {
                            ...
                            s || (s = t[o] = {
                                color: p ? a : [a]
                            }), s.symbol || (s.symbol = e && n.clone(e) || (p ? "roundRect" : ["roundRect"])), s.symbolSize || (s.symbolSize = i && n.clone(i) || (p ? r[0] : [r[0], r[0]])), s.symbol = h(s.symbol, function(t) {
                ...
                _renderTicks: function(t, e, i, n, o, h, u, c) {
                    for (var d = this.group, f = o.cx, p = o.cy, g = o.r, m = t.get("min"), v = t.get("max"), y = t.getModel("splitLine"), x = t.getModel("axisTick"), _ = t.getModel("axisLabel"), w = t.get("splitNumber"), b = x.get("splitNumber"), S = l(y.get("length"), g), M = l(x.get("length"), g), A = h, I = (u - h) / w, T = I / b, C = y.getModel("lineStyle").getLineStyle(), L = x.getModel("lineStyle").getLineStyle(), D = _.getModel("textStyle"), P = 0; w >= P; P++) {
                        ...
                        if (y.get("show")) {
                            ...
                            "auto" === C.stroke && E.setStyle({
                                stroke: n(P / w)
                            }), d.add(E)
                        }
                        if (_.get("show")) {
                            var R = a(s.round(P / w * (v - m) + m), _.get("formatter")),
                                O = new r.Text({
                                    style: {
                                        text: R,
                                        x: k * (g - S - 5) + f,
        ...
        t.exports = i(2).extendChartView({
            ...
            render: function(t, e, i, n) {
                ...
                if (!(a.indexOf(o, t) < 0)) {
                    ...
                    var r = n && n.type,
                        l = t.layoutInfo,
                        h = !this._oldTree,
                        u = this._giveContainerGroup(l),
                        c = this._doRender(u, t);
            ...
            _doRender: function(t, e) {
                ...
                var l = e.getData().tree,
                    ...
                    g = [],
                    v = [],
                    y = f(this._renderNode, this, c, d, u, p, g),
                    x = e.getViewRoot();
                i(l.root ? [l.root] : [], h && h.root ? [h.root] : [], t, l === h || !h, x === l.root);
                var v = o(d);
                return this._oldTree = l, this._storage = c, {
                    lastsForAnimation: u,
                    willDeleteEls: v,
                    renderFinally: s
                }
            ...
            _renderNode: function(t, e, i, n, o, r, s, l) {
                ...
                function c(t, e, n) {
                    if ("background" === n) e.invisible = !0, e.__tmWillVisible = !0, o.push(e);
                    else {
                ...
                if (r) {
                    ...
                    if (w) {
                        ...
                        b && (b.setShape({
                            ...
                            fill: r.getVisual("borderColor", !0)
                        }), w.add(b));
                        ...
                        if (!S || !S.length) {
                            var M = v.borderWidth,
                                A = h("content", g);
                            if (A) {
                                var I = Math.max(y - 2 * M, 0),
                                    T = Math.max(x - 2 * M, 0),
                                    C = r.getModel("label.normal"),
                                    L = r.getModel("label.normal.textStyle"),
                                    D = r.getModel().get("name"),
                                    P = L.getTextRect(D),
                                    k = C.get("show");
                    ...
                    l && l.traverse(function(t) {
                        ...
                        m(t, function(t, s) {
                            ...
                            h && ("nodeGroup" === i ? (l = {
                                ...
                                shape: a.extend({}, t.shape)
                            }, t.setShape(h.old), h.fadein ? (t.setStyle("opacity", 0), l.style = {
                                opacity: 1
                ...
                function e(t) {
                    ...
                    if (e) {
                        ...
                        if (i)
                            ...
                            var n = i.node,
                                a = n.hostTree.data.getItemModel(n.dataIndex),
                                o = a.get("link", !0),
        ...
        function n(t, e, i) {
            ...
            t.eachComponent(n, function(t) {
                var n = e.getWidth(),
                    o = e.getHeight(),
                    r = t.get("size") || [],
                    s = x(_(t.get("width"), r[0]), n),
                    l = x(_(t.get("height"), r[1]), o),
                    h = y.getLayoutRect(t.getBoxLayoutParams(), {
                        width: e.getWidth(),
                        height: e.getHeight()
                    }),
                    u = i && i.type,
                    p = b.retrieveTargetInfo(i, t),
                    g = "treemapRender" === u || "treemapMove" === u ? i.rootRect : null,
                    m = t.getViewRoot();
                if ("treemapMove" !== u) {
                    var v = "treemapZoomToNode" === u ? c(t, p, s, l) : g ? [g.width, g.height] : [s, l],
                        S = t.get("sort");
        ...
        function a(t, e) {
            ...
            if (!t.isRemoved()) {
                ...
                var s = t.getModel("itemStyle.normal"),
                    l = s.get("borderWidth"),
                    c = s.get("gapWidth") / 2,
                    d = l - c,
                    f = t.getModel();
        ...
        function o(t, e, i, n) {
            ...
            return t.viewChildren = a, t.setLayout({
        ...
        "use strict";
        i(199), i(296), i(307), i(2).extendComponentView({
            type: "polar"
        })
    }, function(t, e, i) {
        i(341), i(342), i(306)
                ...
                if (r.length) {
                    ...
                    if ("circle" === s)
                        for (var y = r[0].getTicksCoords(), x = i.cx, _ = i.cy, w = 0; w < y.length; w++) {
                            ...
                            for (var S = a.map(r, function(t, e) {
        ...
        var n = i(10),
            ...
            s = n.extend({
                ...
                init: function(t, e, i) {
                    this._data, this._names, this.mergeDefaultAndTheme(t, i),
                        this._initData()
                },
                mergeOption: function(t) {
