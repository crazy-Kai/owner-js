"use strict";
define("src/common/delegate-debug", ["common/jquery-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug"], function(require, exports, module) {
    ...
    var $ = require("common/jquery-debug"),
        ...
        delegate = {},
        SOBY = $("body"),
        off = (SOBY.on, SOBY.off);
    return delegate.on = function(type, trigger, callback) {
        return SOBY.on(type, trigger, function(e) {
            var self = $(this);
            self.hasClass("JS-button-disabled") || callback && callback.call(this, e)
        }), delegate
    }, delegate.off = function() {
        var args = util.setArray(arguments);
        return args[0] = mixNameSpace(args[0]), off.apply(SOBY, args), delegate
    }, delegate
});
"use strict";
