"use strict";
define("src/common/myWidget-debug", ["common/jquery-debug", "common/widget-debug", "common/base-debug", "common/class-debug", "common/attrs-debug", "common/aspect-debug", "common/events-debug", "common/limit-debug", "common/limit-dom-debug", "common/util-debug", "common/promise-debug", "common/daparser-debug", "common/domUtil-debug", "common/handlerbars-debug"], function(require, exports) {
    var $ = require("common/jquery-debug"),
        Widget = require("common/widget-debug"),
        util = require("common/util-debug"),
        daparser = require("common/daparser-debug"),
        ...
        myWidget = Widget.extend({
            ...
            initialize: function(config) {
                ...
                try {
                    myWidget.superclass.initialize.call(me, config), me.element.data("myWidget", me)
                } catch (e) {
            ...
            parseTrigger: function() {
                ...
                trigger.length && (me.triggerNode = trigger, me.get("element") || (me.resetConfig(daparser.parseElement(trigger)), trigger.data("myWidget", me)))
            },
            resetConfig: function(config) {
                var me = this;
                return me.breakEachObj(config, function(val, key) {
                    me.set(key, val)
                }), me
            },
