"use strict";
define("src/model/postMessage/main-debug", ["common/jquery-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/myWidget-debug"], function(require, exports, module) {
    var $ = require("common/jquery-debug"),
        MyWidget = (require("common/util-debug"), require("common/myWidget-debug")),
        PostMessage = MyWidget.extend({
            ...
            destroy: function() {
                $(window).off("message"), PostMessage.superclass.destroy.call(this)
            }
        });
    return PostMessage
});
