"use strict";
define("src/model/poploading/main1-debug", ["common/jquery-debug", "common/widget-debug", "common/base-debug", "common/class-debug", "common/attrs-debug", "common/aspect-debug", "common/events-debug", "common/limit-debug", "common/limit-dom-debug", "alinw/dialog/2.0.6/dialog-debug", "alinw/loading/1.1.0/loading-debug"], function(require, exports, module) {
    var Widget = (require("common/jquery-debug"), require("common/widget-debug")),
        Dialog = require("alinw/dialog/2.0.6/dialog-debug"),
        Loading = require("alinw/loading/1.1.0/loading-debug"),
        Poploading = Widget.extend({
            clssName: "Poploading",
            attrs: {
                needText: !1
            },
            ...
            initProps: function() {
                ...
                me.get("needText") && (content = '<div class="popLoading-content" style="padding-top:5px;padding-bottom:21px;"></div><span class="fn-color-666" style="position:absolute;bottom:7px;left:45px;">数据保存中</span>'), me.dialog = new Dialog({
                    content: content,
                    width: "auto",
                    height: "auto",
                    closeTpl: ""
                }).render(), me.loadExp = new Loading({
            ...
            destroy: function() {
                var me = this;
                me.loadExp.remove(), me.dialog.destroy(), Poploading.superclass.destroy.call(me)
            },
            show: function() {
                var me = this;
                me.dialog.show()
            ...
            hide: function() {
                var me = this;
                return me.dialog.hide(), me
            },
            Statics: {
                show: function(config) {
                    var me = this,
                        loading = Poploading.loading;
                    loading || (loading = Poploading.loading = new me(config), Poploading.guid = 0), Poploading.guid++, loading.render().show()
                },
                hide: function() {
                    var loading = Poploading.loading;
                    loading && (Poploading.guid--, 0 === Poploading.guid && (loading.hide(), loading.destroy(), delete Poploading.loading))
                }
            }
        });
    return Poploading
