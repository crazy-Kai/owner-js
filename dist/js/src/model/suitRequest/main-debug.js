"use strict";
define("src/model/suitRequest/main-debug", ["common/myWidget-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug"], function(require, exports, module) {
    function hideDiv(node) {
        MyWidget.hide(node), MyWidget.disabledTrue(node)
    }

    function showDiv(node) {
        MyWidget.show(node), MyWidget.disabledFalse(node)
    }
    var MyWidget = require("common/myWidget-debug"),
        $ = MyWidget.jQuery,
        util = require("common/util-debug"),
        handlerbars = MyWidget.handlerbars,
        Suitrequest = MyWidget.extend({
            ...
            events: {
                ...
                "click .JS-trigger-click-add": function(e) {
                    this.suAddSuit({
                        deleteFlag: !0
                    }, $(e.target).closest(".JS-trigger-click-add"))
                },
                "click .JS-trigger-click-delete": "suDelSuit"
            },
            initProps: function() {
                var me = this;
                me.suAddSuitemple = handlerbars.compile(me.$(".JS-target-temple").html()), me.suAmount = $("#selectionOrder").data("totalFee") || 0
            },
            setup: function() {
                var me = this;
                !me.get("size") && me.suAddSuit({
                    deleteFlag: !1
                })
            },
            suChangeSuit: function(e) {
                ...
                if (e) {
                    ...
                    hideDiv(money), hideDiv(otherSuit), hideDiv(law500), val && ("other" === val ? showDiv(otherSuit) : (showDiv(money), pay = me.get("requestType")[val] * me.suAmount, "refund_three" === val && (pay = +me.suAmount, showDiv(law500), 3 * pay <= 500 ? pay += 500 : pay *= 4), me.soSetMoney(money, pay)))
                }
                return me
            },
            suAddSuit: function(obj, node) {
                var me = this;
                return node ? node.before(me.suAddSuitemple(obj)) : me.element.html(me.suAddSuitemple(obj)), me
            },
            suDelSuit: function(e) {
                var me = this;
                return e && me.closest(e.target, ".JS-target-list").remove(), me
            },
            soReset: function() {
                var me = this;
                return me.element.html(me.suAddSuitemple({
                    deleteFlag: !1
                })), me
            },
            soSetMoney: function(node, pay) {
                var me = this;
                return node.find(".JS-target-money-text").html(util.formatMoney(pay, 2)), node.find(".JS-target-money-input").val(pay), me
            }
        });
    return Suitrequest
});
