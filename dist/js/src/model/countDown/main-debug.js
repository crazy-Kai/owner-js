"use strict";
define("src/model/countDown/main-debug", ["common/jquery-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/base-debug", "common/class-debug", "common/attrs-debug", "common/aspect-debug", "common/events-debug"], function(require, exports, module) {
    var util = (require("common/jquery-debug"), require("common/util-debug")),
        Base = require("common/base-debug"),
        CountDown = Base.extend({
            attrs: {
                dayStamp: 864e5,
                hourStamp: 36e5,
                minuteStamp: 6e4,
            ...
            initialize: function(config) {
                var me = this;
                return CountDown.superclass.initialize.call(me, config), me.set("targetTimestamp", new Date(me.get("target")).getTime()), me
            },
            use: function() {
                var todayTimestamp, differ, me = this,
                    targetTimestamp = me.get("targetTimestamp");
                return isNaN(targetTimestamp) ? util.log(targetTimestamp, "时间戳解析错误。") : (todayTimestamp = (new Date).getTime(), differ = targetTimestamp - todayTimestamp, differ <= 0 ? util.log("目标：" + me.get("target") + " 比现在小。") : me.formatTimestamp(differ))
            },
