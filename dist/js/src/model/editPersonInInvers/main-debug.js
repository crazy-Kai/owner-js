"use strict";
define("src/model/editPersonInInvers/main-debug", ["common/jquery-debug", "common/dialog-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "model/ajax/main-debug", "model/modal/main-debug", "common/validator-debug", "common/myWidget-debug", "src/model/editPersonInInvers/edit-hbs-debug", "src/model/editPersonInInvers/detail-hbs-debug"], function(require, exports, module) {
        ...
        var dia = Dialog.show(editHbs(data), {
            ...
            events: {
                ...
                'click [data-trigger="submit"]': function() {
                    Validator.oneExecute(this.element, '[data-widget="validator"]') || submitFormToRpc.call(theEditPersonInInvers, this)
                }
            },
            autoShow: !1
        });
        return dia.after("show", function() {
    ...
    function disabledInputInHiddenTable() {
        ...
        me.$("[data-target]").each(function() {
            var node = $(this);
            node.hasClass("fn-hide") ? domUtil.disabledTrue(node) : domUtil.disabledFalse(node)
        })
    }

    function switchTableFormType(type) {
        var me = this;
        me.$("[data-target]").addClass("fn-hide"), me.$('[data-target="' + type + '"]').removeClass("fn-hide"), disabledInputInHiddenTable.call(me)
    }
    ...
    function submitFormToRpc(dia) {
        ...
        new Ajax({
            ...
            node.length ? node.replaceWith(detailHbs(rtv)) : me.element.append(detailHbs(rtv)), me.trigger("saveSuccess")
        }).submit()
    }
    var $ = require("common/jquery-debug"),
        ...
        editHbs = require("src/model/editPersonInInvers/edit-hbs-debug"),
        detailHbs = require("src/model/editPersonInInvers/detail-hbs-debug"),
        EditPersonInInvers = MyWidget.extend({
                ...
                'click [data-trigger="delete"]': function(e) {
                    ...
                    Modal.confirm("提醒", "您确定要删除嘛？", function() {
                        new Ajax({
                            ...
                            node.remove(), me.trigger("deleteSuccess")
                        }).submit()
                    })
                }
            },
            ...
            setup: function() {
                ...
                me.delegateEvents(me.triggerNode, "click", function(e) {
                    initDialog(me, $.extend({
                        entityType: "normal"
                    }, me.get("param")))
                }), me.set("parentNode", me.triggerNode.parent()), me.triggerNode.before(me.element)
            }
        });
