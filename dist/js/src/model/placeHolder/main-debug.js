"use strict";
define("src/model/placeHolder/main-debug", ["common/jquery-debug", "common/widget-debug", "common/base-debug", "common/class-debug", "common/attrs-debug", "common/aspect-debug", "common/events-debug", "common/limit-debug", "common/limit-dom-debug"], function(require, exports, module) {
    var $ = require("common/jquery-debug"),
        Widget = require("common/widget-debug"),
        config = window.CONFIG,
        PlaceHolderInput = Widget.extend({
            attrs: {
                shadowTextCss: null,
                parentTextCss: null,
            ...
            showPlaceHolder: function(e) {
                ...
                !me.inEvent || "blur" !== e.type && "paste" !== e.type && "keydown" !== e.type && "input" !== e.type && "values" !== e.originalEvent.propertyName || (me.inEvent = !1, setTimeout(function() {
                    me.isEmpty() ? $holder.show() : $holder.hide(), me.inEvent = !0
                }, 0))
            },
            setup: function() {
                var me = this,
                    documentMode = document.documentMode;
                !documentMode || 8 !== documentMode && 9 !== documentMode || (me.initNode(), me.element.trigger("blur"))
            },
            initNode: function() {
                var textareaCss, me = this,
                    $input = $(me.element),
                    ...
                    $parent = $("<div>"),
                    $holder = $("<div>");
                me.inEvent = !0, $input.removeAttr("placeholder"), $input.css({
                    position: "relative",
                    "z-index": 2,
                ...
                }, me.get("parentTextCss"))), $holder.html(placeHolderText), "textarea" === $input.prop("type") && (textareaCss = {
                    "line-height": "20px",
                    top: "10px"
                }), $holder.css($.extend({
                    ...
                    color: "#999",
                    "z-index": 1
                }, textareaCss, me.get("shadowTextCss"), me.get("shadowMoreTextCss"))), me.set("holder", $holder), $input.after($parent), $input.appendTo($parent), $input.before($holder)
            }
        });
