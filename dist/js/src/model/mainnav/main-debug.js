"use strict";
define("src/model/mainnav/main-debug", ["common/jquery-debug", "common/domUtil-debug", "common/util-debug", "common/promise-debug", "common/limit-debug", "common/limit-dom-debug", "common/handlerbars-debug", "common/myWidget-debug"], function(require, exports, module) {
    var $ = require("common/jquery-debug"),
        domUtil = require("common/domUtil-debug"),
        MyWidget = require("common/myWidget-debug"),
        MainNav = MyWidget.extend({
            clssName: "MainNav",
            attrs: {
                element: window,
                nav: "#main-nav"
            ...
            initProps: function() {
                var nav, me = this;
                nav = me.nav = $(me.get("nav")), me.navPar = nav.parent()
            },
            setup: function() {
                var me = this;
                me.shouldFixed()
            ...
            shouldFixed: function() {
                ...
                if (me.nav.length) {
                    ...
                    windowTop > navParTop ? me.nav.addClass("main-nav-fixed") : me.nav.removeClass("main-nav-fixed")
                }
            }
        });
    return MainNav
