    ...
    if (caseId) {
        ...
        if(!cookie.get('openText')){
            $('#notic-check-next').click( function (e) {
                ...
                Modal.show('/suit/trial/trialTest.htm?caseId='+$('#caseId').val()+'&entityRole='+$('#entityRole').val(),
                {width:1200, height:950, closeTpl: '<button class="fn-btn fn-btn-default" type="button">下一步</button>'}).after('hide', function(){
