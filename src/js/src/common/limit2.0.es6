...
define(function(require, exports) {
	...
	// --错误日志-- //
		...
		// 快捷方法
		defineIt('T.T', {
			value: (...args) => limit.log.apply(null, ['error', ...args])
		});
		defineIt('!!!', {
			value: (...args) => limit.log.apply(null, ['warn', ...args])
		});
		defineIt('...', {
			value: (...args) => limit.log.apply(null, ['log', ...args])
		});
